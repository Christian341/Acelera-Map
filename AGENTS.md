...
- `ARCHITECTURE.md/` — explain what lives here and when agents should edit it.
- `BACKLOG.md/` — explain what lives here and when agents should edit it.
- `commands/` — explain what lives here and when agents should edit it.
- `components/` — explain what lives here and when agents should edit it.
- `constants.ts/` — explain what lives here and when agents should edit it.
- `index.html/` — explain what lives here and when agents should edit it.
- `index.tsx/` — explain what lives here and when agents should edit it.
